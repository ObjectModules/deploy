...
**_Guidance:_**
* As shown in the table, channel consist of twelve (12) rows. You may choose whatever the links you like however the first four (4) links of each channels will need to be the same. They also need to be arranged on pair in six (6) groups of two (2) channels each  
