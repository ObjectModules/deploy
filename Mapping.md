...
An easy case is when we are hungry so that we need a food to eat. If we don't eat *the hungry* will not became and end point, it is stack there. It will need to be settled in order to continue our living. 
