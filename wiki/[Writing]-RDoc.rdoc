cat:: [[:arrow_double_down:|https://github.com/hyip/rating/wiki/Introduction]]
<table>
  <thead>
    <tr>
...
created from a {RDoc Markup file}[https://github.com/rdoc/rdoc/blob/master/ExampleRDoc.rdoc].
