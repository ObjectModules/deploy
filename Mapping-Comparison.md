...
Now, we left only to explain you about the last process called _[[an overall|Mapping-Overall]]_ which will let the whole system back to the _[[routine|Mapping-Routine]]_ and making the final result of _[[a merging|Mapping-Merging]]_ to become settled.
