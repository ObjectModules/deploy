...
* Above the line: You send<sup><i>1</i></sup> _a query_ to _Google Search_, it read<sup><i>2</i></sup> by _Google Search_ 
...
* Above the line: You send<sup><i>1</i></sup> `info` to `hyip world`, it read<sup><i>2</i></sup> by `hyip world` 
