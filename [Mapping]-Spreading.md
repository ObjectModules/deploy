...
* Below the line: _Google_ write<sup><i>3</i></sup> a result and _your computer_ display<sup><i>4</i></sup> it  
...
* Below the line: `world` write<sup><i>3</i></sup> a result and `hyip info` display<sup><i>4</i></sup> it
