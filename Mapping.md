...
You may also identify your potential factors using <a heref="https://en.wikipedia.org/wiki/Ishikawa_diagram" target="_blank">Fishbone</a>_ Diagram to then put the result the mapping concept, let's it spread it again when a solution is not going to be achieved.
