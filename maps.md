...
**_Caution:_**
You can follow us for assignment of your domain follows to the above sample. Take a look at the assigned url's for the last two. This two will need to use subdomain from your main domain as they will be use in _[implementing cross domain](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing)_.
