...
When it is going to end whole process it will return the original mapping which number of elements is also _four (4)_. Means all back to the routines. Other process is no more required. In our concept this we can call as _the settlement_. 
