...
As you are aware this section is about a process of what we called as `info`. We collect, create and write on the code to proceed all aspect, in related to its part on the concept, into the repo and explain it in the same configuration into the arrangement of the topics in the wiki. 
