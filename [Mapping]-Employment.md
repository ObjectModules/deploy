...
When we see the explanation of what SQL is, it contain of statement that structured to present a process on a Library, so it is actually a code language. Let's call it here as _Script_ then.
