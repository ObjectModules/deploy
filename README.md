...
This is a basic core and background philosophy of the project in general. You can find the update and development of this plan by visiting our main site named [The World of High Yield Investment Program (HYIP)](http://hyip.world/). You may also get in detail later in our tutorial on how we started to get this site *Up and Running on Github*.
