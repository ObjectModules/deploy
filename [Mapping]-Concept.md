...
The diagram as shown in _Figure 1_ has 4 elements. Each represent each element inside the mapping. We just need to put what we need as a text above the box. 
