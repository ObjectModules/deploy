...
So we left only to explain about the last process called _[[an overall|Mapping-Overall]]_ which let the whole system back to the _[[routine|Mapping-Routine]]_ and making all the processes to become final and settled.
