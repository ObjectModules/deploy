...
When we see the explanation of what _SQL_ is, it contain of statement that structured to present a process on a Library, so it is actually a code language. So it is kind of a scripting language.
