...
This is just a model to give you a figure on how we are going to start. You can find the update of this plan on our main site about [The World of High Yield Investment Program (HYIP)](http://hyip.world/) which we have started to get it Up and Running on Github.
