...
**_Guidance:_**
* Channel consist of twelve (12) units, six (6) units for main and six (6) units for wiki. You may choose the links however the first four (4) links of each channels will need to be the same. They shall go on pair in six (6) groups of two (2) units each  
